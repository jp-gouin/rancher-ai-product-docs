...
* **Resource Metadata**: Details about the current resource (e.g., a specific Deployment, Node, or Fleet Bundle) shown in the UI.
...
The following exhaustive list of actions defines the data collected from the Rancher Manager and downstream clusters:
...
These actions fetch data against the environment and share the result with the LLM. 
